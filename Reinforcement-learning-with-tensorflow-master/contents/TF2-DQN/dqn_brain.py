...
class DQN:
    ...
    def _build_net(self):
        ...
        x = tf.keras.layers.Conv2D(32, (3, 3), activation = 'relu', input_shape = (28, 28, 3))(eval_inputs) 
        ...
        x = tf.keras.layers.Conv2D(32, (3, 3), activation = 'relu', input_shape = (28, 28, 3))(target_inputs) 
        x = tf.keras.layers.MaxPooling2D(2,2)(x)
        x = tf.keras.layers.Conv2D(64, (3, 3), activation = 'relu')(x)
        x = tf.keras.layers.MaxPooling2D(2,2)(x)
        x = tf.keras.layers.Flatten()(x)
